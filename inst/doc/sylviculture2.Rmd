...
```{r gIeq, echo=FALSE, fig.cap='Figure 1: Ecosystem resilience after 600 years with taxonomic and functional diversity. Cummulative integral from ecosystem distance to forest dynamic equilibrium after 600 years was represented against functional richness [FRic, @villeger_new_2008] ; dot shapes represents the species richness whereas dot color represents the disturbed basal area (m2/ha).', cache=TRUE}
Ieq %>% 
...
```{r Ieq.structure all var, echo=FALSE, fig.cap='Figure S1.1: Ecosystem resilience after 600 years with taxonomic and functional diversity. Cummulative integral from ecosystem distance to forest dynamic equilibrium after 600 years was represented against functional diversity [FRIC, FEve, FDiv, and FDis, @villeger_new_2008] and level of disturbed basal area (ba in m2/ha); dot shapes represents the species richness.', cache=TRUE}
Ieq %>% 
  left_join(., doe, by = 'sim') %>% 
  filter(time == 600) %>%
...
```{r Ieq.production all var, echo=FALSE, fig.cap='Figure S1.1: Ecosystem resilience after 600 years with taxonomic and functional diversity. Cummulative integral from ecosystem distance to forest production equilibrium after 600 years was represented against functional diversity [FRIC, FEve, FDiv, and FDis, @villeger_new_2008] and level of disturbed basal area (ba in m2/ha); dot shapes represents the species richness.', cache=TRUE}
Ieq %>% 
  left_join(., doe, by = 'sim') %>% 
  filter(time == 600) %>%
