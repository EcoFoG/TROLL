...
```{r graph}
n10 <- compareplot(sim, 'abu10', legend = F)
n30 <- compareplot(sim, 'abu30')
agb <- compareplot(sim, 'agb', legend = F)
gpp <- compareplot(sim, 'gpp', legend = F)
...
```{r graph sup}
ggplotly(compareplot(sim, 'abu10'))
rm(list = ls()[-which(ls() == 'sim')]) ; invisible(gc())
ggplotly(compareplot(sim, 'abu30'))
rm(list = ls()[-which(ls() == 'sim')]) ; invisible(gc())
ggplotly(compareplot(sim, 'agb'))
rm(list = ls()[-which(ls() == 'sim')]) ; invisible(gc())
ggplotly(compareplot(sim, 'gpp'))
rm(list = ls()[-which(ls() == 'sim')]) ; invisible(gc())
```
