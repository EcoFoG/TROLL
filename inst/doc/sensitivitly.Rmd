...
```{r graph sup}
ggplotly(compareplot(sim, 'abu10', reduce = 24))
rm(list = ls()[-which(ls() == 'sim')]) ; invisible(gc())
ggplotly(compareplot(sim, 'abu30', reduce = 24))
rm(list = ls()[-which(ls() == 'sim')]) ; invisible(gc())
ggplotly(compareplot(sim, 'agb', reduce = 24))
rm(list = ls()[-which(ls() == 'sim')]) ; invisible(gc())
ggplotly(compareplot(sim, 'gpp', reduce = 24))
rm(list = ls()[-which(ls() == 'sim')]) ; invisible(gc())
```
