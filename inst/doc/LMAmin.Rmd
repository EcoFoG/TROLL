...
<!-- First we can clearly see that allometry seems to greatly change between biomes (see figure 12). -->
...
<!-- Figure 12: Leaf mass per area (LMA) and leaflifespan (LL). *Leaf mass per area (LMA in $g.m^{-2}$) and leaf lifespan (LL in $months$) are taken in GLOPTNET dataset from @wright_worldwide_2004 with a linear regression by biome.* -->
